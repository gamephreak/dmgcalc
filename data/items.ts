...
const GSC: string[] = [
  'Berry',         'Berry Juice',  'Black Belt',     'Black Glasses',
  'Bright Powder', 'Charcoal',     'Dragon Fang',    'Focus Band',
  'Gold Berry',    'Hard Stone',   'King\'s Rock',   'Leftovers',
  'Light Ball',    'Magnet',       'Metal Coat',     'Metal Powder',
  'Miracle Seed',  'Mystic Water', 'Never-Melt Ice', 'Pink Bow',
  'Poison Barb',   'Polkadot Bow', 'Sharp Beak',     'Silver Powder',
  'Soft Sand',     'Soothe Bell',  'Spell Tag',      'Stick',
...
const ADV: string[] = GSC.concat([
  ...
  'Enigma Berry', 'Figy Berry',     'Ganlon Berry',   'Grepa Berry',
  'Hondew Berry', 'Iapapa Berry',   'Kelpsy Berry',   'Lansat Berry',
  'Leppa Berry',  'Liechi Berry',   'Mago Berry',     'Magost Berry',
  'Mental Herb',  'Nanab Berry',    'Nomel Berry',    'Oran Berry',
  'Pamtre Berry', 'Pecha Berry',    'Persim Berry',   'Petaya Berry',
  'Pinap Berry',  'Pomeg Berry',    'Qualot Berry',   'Rabuta Berry',
  'Rawst Berry',  'Razz Berry',     'Salac Berry',    'Sea Incense',
  'Silk Scarf',   'Sitrus Berry',   'Soul Dew',       'Spelon Berry',
  'Starf Berry',  'Tamato Berry',   'Watmel Berry',   'Wepear Berry',
...
const DPP: string[] = ADV.concat([
  ...
  'Destiny Knot', 'Draco Plate',  'Dread Plate',  'Earth Plate',
  'Expert Belt',  'Fist Plate',   'Flame Orb',    'Flame Plate',
  'Focus Sash',   'Grip Claw',    'Griseous Orb', 'Haban Berry',
  'Icicle Plate', 'Insect Plate', 'Iron Ball',    'Iron Plate',
  'Jaboca Berry', 'Kasib Berry',  'Kebia Berry',  'Lagging Tail',
  'Life Orb',     'Lustrous Orb', 'Macho Brace',  'Meadow Plate',
  'Metronome',    'Micle Berry',  'Mind Plate',   'Muscle Band',
  'Occa Berry',   'Odd Incense',  'Passho Berry', 'Payapa Berry',
  'Quick Powder', 'Razor Fang',   'Reaper Cloth', 'Rindo Berry',
  'Rock Incense', 'Rose Incense', 'Rowap Berry',  'Shed Shell',
  'Shuca Berry',  'Sky Plate',    'Smooth Rock',  'Splash Plate',
  'Spooky Plate', 'Sticky Barb',  'Stone Plate',  'Tanga Berry',
  'Toxic Orb',    'Toxic Plate',  'Wacan Berry',  'Wave Incense',
  'Wide Lens',    'Wise Glasses', 'Yache Berry',  'Zap Plate',
  'Zoom Lens'
]);

const BW: string[] = DPP.concat([
  'Air Balloon',  'Binding Band', 'Bug Gem',     'Burn Drive',   'Chill Drive',
  'Dark Gem',     'Dragon Gem',   'Douse Drive', 'Electric Gem', 'Eviolite',
  'Fighting Gem', 'Fire Gem',     'Float Stone', 'Flying Gem',   'Ghost Gem',
  'Grass Gem',    'Ground Gem',   'Ice Gem',     'Normal Gem',   'Poison Gem',
  'Psychic Gem',  'Red Card',     'Ring Target', 'Rock Gem',     'Shock Drive',
  'Steel Gem',    'Water Gem'
]);

export const MEGA_STONES: {[item: string]: string} = {
  'Absolite': 'Absol',
  'Abomasite': 'Abomasnow',
...
const XY: string[] = BW.concat(Object.keys(MEGA_STONES))
                         .concat([
                           'Assault Vest', 'Blue Orb', 'Fairy Gem', 'Kee Berry',
                           'Maranga Berry', 'Pixie Plate', 'Power Herb',
                           'Red Orb', 'Roseli Berry', 'Safety Goggles'
                         ])
                         .sort();

const SM: string[] = XY.concat([
  'Adrenaline Orb',  'Aloraichium Z',  'Bug Memory',      'Buginium Z',
  'Dark Memory',     'Darkinium Z',    'Decidium Z',      'Dragon Memory',
  'Dragonium Z',     'Eevium Z',       'Electric Memory', 'Electric Seed',
  'Electrium Z',     'Enigmatic Card', 'Fairium Z',       'Fairy Memory',
  'Fighting Memory', 'Fightinium Z',   'Fire Memory',     'Firium Z',
  'Flying Memory',   'Flyinium Z',     'Ghost Memory',    'Ghostium Z',
  'Grass Memory',    'Grassium Z',     'Grassy Seed',     'Ground Memory',
  'Groundium Z',     'Ice Memory',     'Icium Z',         'Incinium Z',
  'Kommonium Z',     'Lunalium Z',     'Lycanium Z',      'Marshadium Z',
  'Mewnium Z',       'Mimikium Z',     'Misty Seed',      'Normalium Z',
  'Pikanium Z',      'Pikashunium Z',  'Pink Nectar',     'Poison Memory',
  'Poisonium Z',     'Primarium Z',    'Protective Pads', 'Psychic Memory',
  'Psychic Seed',    'Psychium Z',     'Purple Nectar',   'Red Nectar',
  'Rock Memory',     'Rockium Z',      'Snorlium Z',      'Solganium Z',
  'Steel Memory',    'Steelium Z',     'Tapunium Z',      'Ultranecrozium Z',
  'Water Memory',    'Waterium Z',     'Yellow Nectar'
]);
...
export function getFlingPower(item: string|undefined) {
